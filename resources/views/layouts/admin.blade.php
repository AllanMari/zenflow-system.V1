...
$navGroups = [
    'Overview' => [
        ...
        ['r'=>'admin.appointments','l'=>'Appointments','p'=>'admin.appointments*','i'=>'M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
    ],
    'Management' => [
        ...
        $navItems[] = [
            'r' => 'admin.room-tracking',
            'l' => 'Room Tracking',
            'p' => 'admin.room-tracking',
        ...
        ['r'=>'attendance.today','l'=>'Attendance','p'=>'attendance.today','i'=>'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
